...
/* =====================================================================
   Pessoas do grupo — código de convite, integrantes e sair do grupo.
   =====================================================================
   Antes vivia dentro de DetalheGrupo.tsx, junto com o feed. Separado numa
   tela própria (aberta pelo botão "Pessoas" no cabeçalho do grupo) porque
   é uma responsabilidade diferente: não é conteúdo consumido o tempo
   todo, é administração — quem está no grupo, e como convidar mais
   gente. Autossuficiente de propósito: carrega tudo no próprio mount, sem
   depender de estado de nenhuma outra tela.
   ===================================================================== */

const DIAS_CURTOS = ["D", "S", "T", "Q", "Q", "S", "S"];

export function PessoasGrupo() {
  ...
  if (falhou) {
    return (
      <div className="tela">
        <Voltar to={grupoId ? `/grupo/${grupoId}` : "/grupo"} rotulo="Grupo" className="mb-4" />
  ...
  return (
    <div className="tela">
      <header className="mb-4">
        <Voltar to={`/grupo/${grupoId}`} rotulo={grupo.nome} className="mb-1" />
